...
Write a regular expression to match a valid full name. A valid full name has the following characteristics:
...
A valid number has the following characteristics:
	...
	- After that, it’s followed by the number itself. The number consists of 7 digits (separated in two groups 
